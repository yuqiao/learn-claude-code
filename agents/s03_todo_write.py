...
Usage:
    python s03_todo_write.py        # normal mode
    python s03_todo_write.py -v     # verbose mode (print API calls)
"""
...
# 解析命令行参数
parser = argparse.ArgumentParser(description="TodoWrite with optional verbose logging")
