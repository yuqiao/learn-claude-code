...
Usage:
    python s06_context_compact.py        # normal mode
    python s06_context_compact.py -v     # verbose mode (print API calls)
"""
...
# 解析命令行参数
parser = argparse.ArgumentParser(description="Context Compact with optional verbose logging")
